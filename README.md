...
2. Revenue is highly dependent on one-time customers
Repeat customers contribute less than 6% of total revenue. This reveals weak customer retention and low customer lifetime value, making the growth model heavily reliant on continuous acquisition.

3. Repeat behavior is delayed rather than immediate
Most repeat purchases occur after 60+ days, with minimal repeat activity in the first 30 days following a customer’s first purchase. This suggests weak early engagement and limited habit formation.

4. Customer loyalty is category-dependent
Repeat purchase behavior varies significantly across product categories. Certain consumable and lifestyle categories show strong repeat potential, while many high-volume categories function primarily as one-time purchase drivers.
...
High-revenue categories should be optimized for conversion and cross-sell, while high-repeat categories should be scaled to improve customer lifetime value.
...
Product & Retention Deep Dive Dashboard
Repeat share by category, repeat order volume, and revenue concentration (Pareto)
...
Tableau Public (executive dashboards, storytelling)

Business analytics & strategy

Retention and growth analysis
